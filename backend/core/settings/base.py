...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-3h8i4e)3b!m)drwlsd=3v*w$k)v1==xhbag)gf!k343-cj3ow9",
)
...
if DB_ENGINE == "django.db.backends.sqlite3":
    DATABASES = {
        "default": {
            ...
            if config("DB_NAME", default="db.sqlite3") == ":memory:"
            else BASE_DIR / config("DB_NAME", default="db.sqlite3"),
        }
    }
else:
